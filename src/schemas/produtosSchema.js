...
const produtoSchema = joi.object({
    ...
    quantidade_estoque: joi.number().positive().integer().required().messages({
        "number.integer":
            "O campo quantidade deve ser preenchido com um número inteiro",
        "number.positive":
            "O campo quantidade deve ser preenchido com um número positivo",
    ...
    valor: joi.number().positive().integer().required().messages({
        "number.integer":
            "O campo valor deve ser preenchido com um número inteiro, em centavos",
        "any.required": "O campo valor é obrigatório.",
        "number.positive":
            "O campo valor deve ser preenchido com um número positivo",
        "number.base": "O campo valor é obrigatório.",
    }),
    categoria_id: joi.number().positive().integer().required().messages({
        "number.integer":
            "O campo categoria deve ser preenchido com um número inteiro",
        "number.positive":
            "O campo categoria deve ser preenchido com um número positivo",
